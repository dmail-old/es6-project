...
export var HttpCache = proto.extend({
...
export var HttpClient = proto.extend({
	retryTimeout: 100,
	redirectLimit: 20,
	lastRetry: 0,
	aborted: false,
	cache: HttpCache.create(),
	cachedResponse: null,
	...
	createRequest: function(options){
		return HttpRequest.create(options);
	},

	createResponse: function(options){
		return HttpResponse.create(options);
	},
